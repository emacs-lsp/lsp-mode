...
** Supported languages
   ...
   | F#                    | [[https://github.com/fsharp/FsAutoComplete][fsautocomplete]]                            | Yes            | Clone the [[][repository]], run ./build.sh LocalRelease. Set lsp-fsharp-server-path, and lsp-fsharp-server-runtime.  | No                           |
