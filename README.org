...
** Overview
   _Configuration change: starting from v6.2.1 [[https://github.com/emacs-lsp/lsp-ui][lsp-ui]] won't be enabled by default. Refer to configuration section on how to enable it._
...
**** Spacemacs
     ...
     To enable [[https://github.com/emacs-lsp/lsp-ui][lsp-ui]] add the following lines into =dotspacemacs/user-config=.
     #+BEGIN_SRC emacs-lisp
...
**** use-package
     ...
     #+BEGIN_SRC emacs-lisp
       ...
       ;; optionally if you want to use flycheck and/or fancy GUI.
       (use-package lsp-ui :commands lsp-ui-mode)

       ;; company integration
       (use-package company-lsp :commands company-lsp)

       ;; helm integration for interactive alternative of `xref-apropos'
       (use-package helm-lsp :commands helm-lsp-workspace-symbol)

       ;; same as `helm-lsp' but use `ivy'
       (use-package lsp-ivy :commands ivy-lsp-workspace-symbol)

       ;; `treemacs' integration
       (use-package lsp-treemacs :commands lsp-treemacs-errors-list)

       ;; optionally if you want to use visual debugger
