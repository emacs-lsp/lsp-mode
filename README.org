...
** Overview
   ...
   *This release is breaking refer to the configuration section for upgrade instruction.*
   ...
   - As you type reporting of parsing and compilation errors (via [[https://github.com/flycheck/flycheck][flycheck]]/[[https://github.com/emacs-lsp/lsp-ui][lsp-ui]] or builtin ~flymake~ when Emacs > 26)
...
* Configuration
  ...
  - ~lsp-prefer-flymake~ - auto-configure to prefer `flymake' over `lsp-ui' if both are present.
