...
(lsp-interface (pwsh:ApplyCodeActionEdits (:command :arguments) nil))
(lsp-interface (pwsh:ApplyCodeActionEditsArguments (:StartLineNumber :EndLineNumber :StartColumnNumber :EndColumnNumber :Text) nil))
(lsp-interface (pwsh:ShowCodeActionDocumentation (:arguments) nil))
