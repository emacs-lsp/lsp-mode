...
(lsp-interface (Command (:title :command) (:arguments)))
...
(lsp-interface (pwsh:ApplyCodeActionEdits (:StartLineNumber :EndLineNumber :StartColumnNumber :EndColumnNumber :Text) nil)
               (pwsh:ApplyCodeActionEditsRequest (:range :newText) nil))
