...
(defcustom lsp-client-packages
  '(ccls lsp-actionscript lsp-ada lsp-angular lsp-bash lsp-beancount lsp-clangd lsp-clojure lsp-cmake
         ...
         lsp-tailwindcss lsp-tex lsp-terraform lsp-toml lsp-v lsp-vala lsp-verilog lsp-vetur lsp-vhdl lsp-vimscript lsp-volar lsp-xml
...
(defconst lsp-downstream-deps
  '(;; external packages
    ...
    lsp-vimscript lsp-volar lsp-xml lsp-yaml lsp-zig)
