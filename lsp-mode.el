...
(defcustom lsp-client-packages
  '(ccls lsp-ada lsp-bash lsp-clients lsp-clojure lsp-crystal lsp-csharp lsp-css lsp-dart lsp-dhall
         ...
         lsp-java lsp-json lsp-lua lsp-metals lsp-perl lsp-php lsp-pwsh lsp-pyls lsp-python-ms lsp-rust
         lsp-solargraph lsp-terraform lsp-verilog lsp-vetur lsp-vhdl lsp-xml lsp-yaml lsp-sqls lsp-svelte)
