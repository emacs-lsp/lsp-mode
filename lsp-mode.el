...
(defcustom lsp-client-packages
  '(ccls lsp-ada lsp-angular lsp-bash lsp-clients lsp-clojure lsp-cmake lsp-crystal lsp-csharp lsp-css lsp-dart lsp-dhall
         lsp-dockerfile lsp-elm lsp-erlang lsp-eslint lsp-fsharp lsp-gdscript lsp-go lsp-groovy lsp-haskell lsp-haxe
         lsp-java lsp-json lsp-lua lsp-nim lsp-metals lsp-perl lsp-php lsp-pwsh lsp-pyls
