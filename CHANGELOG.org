...
** Release 6.3
  ...
  * Improve lsp-mode completion performance by supressing non completion related features when completion is active.
  ...
  * Display images when rendering markdown(usefull for latex language servers).
